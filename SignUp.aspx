    ...
    <div>
        ...
        <div class="w3-container">
            <div class="w3-card-4 w3-animate-right" style="width:43%; margin:auto;" id="divSignup">
                ...
                <table>
                    <tr>
                        <td><label  class="lbl">Phone</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtPhone" runat="server" CssClass="txt w3-xlarge" TextMode="Phone" Required placeholder="Your Phone/Mobile No."></asp:TextBox></td>
                    </tr>
                </table>
                <br />
